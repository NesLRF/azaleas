...
<head>
  ...
  <title>AVP Azaleas | Iniciar sesión</title>
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg">Inicie sesión para ingresar al sitio</p>
      ...
      <div class="social-auth-links text-center mt-2 mb-3">
        <p class="mb-1">
          ...
          <p class="mb-0">
            <a href="{{ route('register') }}" class="text-center">¿No tienes cuenta? Registrate</a>
          </p>
      </div>
      <!-- /.social-auth-links -->
